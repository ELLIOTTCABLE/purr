...
global.obfuscate = function obfuscate(val) {
   val = String(val)
   return val.replace(/[a-z]{4,}/gi, function (s) {
      return (
         s.charAt(0) +
         Array.prototype.slice.call(s, 1, -1).reverse().join('') +
         s.charAt(s.length - 1)
      )
   })
}
      ...
      return (function (value, depth) {
         ...
         switch (typeof value) {
            case 'undefined':
               return 'undefined'
            case 'string':
               return utils.string_format(value)
            case 'number':
            case 'boolean':
            ...
            case 'object':
               ...
               switch (type) {
                  case 'Date':
                     return '(object) ' + Date.prototype.toString.call(value)
                  case 'Boolean':
                     return '(object) ' + Boolean.prototype.toString.call(value)
                  case 'Number':
                     return '(object) ' + Number.prototype.toString.call(value)
                  case 'RegExp': // Sometimes a RegExp is not a function
                     return RegExp.prototype.toString.call(value)
                  case 'String':
                     return (
                        '(object) ' +
                        utils.string_format(String.prototype.toString.call(value))
                     )
                  ...
                  case 'ArrayBuffer':
                     return (
                        '(object) <' +
                        Array.prototype.map
                           .call(Uint8Array(value), function (b) {
                              return (b < 16 ? '0' : '') + b.toString(16)
                           })
                           .join(' ') +
                        '>'
            ...
            case 'xml':
               // Weird syntax!! D:
               return eval(
                  'XML.prettyPrinting = false; XML.prototype.function::toXMLString.call(value)',
               )
         }
         return '(unknown)'
      })(value, depth)
      ...
      while (i < len) {
         ...
         switch (code) {
            ...
            case 39 /* single quote */:
               result += (code === quote_code ? '\\' : '') + String.fromCharCode(code)
               break
            case 92:
               result += '\\\\'
               break
...
if (typeof ArrayBuffer !== 'undefined') {
      ...
      encode: function (data, byteOffset, byteLength) {
         ...
         while (byteLength) {
            ...
            if (size) {
               ...
               output[op++] =
                  alphabet[((buffer[0] & 0x03) << 4) | ((buffer[1] & 0xf0) >> 4)]
               output[op++] =
                  size > 1
                     ? alphabet[((buffer[1] & 0x0f) << 2) | ((buffer[2] & 0xc0) >> 6)]
                     : 61
               output[op++] = size > 2 ? alphabet[buffer[2] & 0x3f] : 61
            }
         }
   ...
   var MD5 = function (data, byteOffset, byteLength) {
      ...
      var checksum_h = new Uint32Array([0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476]),
         input = data,
      ...
      while (block_num--) {
         ...
         b[0] += (b[3] ^ (b[1] & (b[2] ^ b[3]))) + ((i[0] + 0xd76aa478) >>> 0)
         b[0] = (b[0] << 7) | (b[0] >>> 25)
         b[0] += b[1]
         b[3] += (b[2] ^ (b[0] & (b[1] ^ b[2]))) + ((i[1] + 0xe8c7b756) >>> 0)
         b[3] = (b[3] << 12) | (b[3] >>> 20)
         b[3] += b[0]
         b[2] += (b[1] ^ (b[3] & (b[0] ^ b[1]))) + ((i[2] + 0x242070db) >>> 0)
         b[2] = (b[2] << 17) | (b[2] >>> 15)
         b[2] += b[3]
         b[1] += (b[0] ^ (b[2] & (b[3] ^ b[0]))) + ((i[3] + 0xc1bdceee) >>> 0)
         b[1] = (b[1] << 22) | (b[1] >>> 10)
         b[1] += b[2]
         b[0] += (b[3] ^ (b[1] & (b[2] ^ b[3]))) + ((i[4] + 0xf57c0faf) >>> 0)
         b[0] = (b[0] << 7) | (b[0] >>> 25)
         b[0] += b[1]
         b[3] += (b[2] ^ (b[0] & (b[1] ^ b[2]))) + ((i[5] + 0x4787c62a) >>> 0)
         b[3] = (b[3] << 12) | (b[3] >>> 20)
         b[3] += b[0]
         b[2] += (b[1] ^ (b[3] & (b[0] ^ b[1]))) + ((i[6] + 0xa8304613) >>> 0)
         b[2] = (b[2] << 17) | (b[2] >>> 15)
         b[2] += b[3]
         b[1] += (b[0] ^ (b[2] & (b[3] ^ b[0]))) + ((i[7] + 0xfd469501) >>> 0)
         b[1] = (b[1] << 22) | (b[1] >>> 10)
         b[1] += b[2]
         b[0] += (b[3] ^ (b[1] & (b[2] ^ b[3]))) + ((i[8] + 0x698098d8) >>> 0)
         b[0] = (b[0] << 7) | (b[0] >>> 25)
         b[0] += b[1]
         b[3] += (b[2] ^ (b[0] & (b[1] ^ b[2]))) + ((i[9] + 0x8b44f7af) >>> 0)
         b[3] = (b[3] << 12) | (b[3] >>> 20)
         b[3] += b[0]
         b[2] += (b[1] ^ (b[3] & (b[0] ^ b[1]))) + ((i[10] + 0xffff5bb1) >>> 0)
         b[2] = (b[2] << 17) | (b[2] >>> 15)
         b[2] += b[3]
         b[1] += (b[0] ^ (b[2] & (b[3] ^ b[0]))) + ((i[11] + 0x895cd7be) >>> 0)
         b[1] = (b[1] << 22) | (b[1] >>> 10)
         b[1] += b[2]
         b[0] += (b[3] ^ (b[1] & (b[2] ^ b[3]))) + ((i[12] + 0x6b901122) >>> 0)
         b[0] = (b[0] << 7) | (b[0] >>> 25)
         b[0] += b[1]
         b[3] += (b[2] ^ (b[0] & (b[1] ^ b[2]))) + ((i[13] + 0xfd987193) >>> 0)
         b[3] = (b[3] << 12) | (b[3] >>> 20)
         b[3] += b[0]
         b[2] += (b[1] ^ (b[3] & (b[0] ^ b[1]))) + ((i[14] + 0xa679438e) >>> 0)
         b[2] = (b[2] << 17) | (b[2] >>> 15)
         b[2] += b[3]
         b[1] += (b[0] ^ (b[2] & (b[3] ^ b[0]))) + ((i[15] + 0x49b40821) >>> 0)
         b[1] = (b[1] << 22) | (b[1] >>> 10)
         b[1] += b[2]

         b[0] += (b[2] ^ (b[3] & (b[1] ^ b[2]))) + ((i[1] + 0xf61e2562) >>> 0)
         b[0] = (b[0] << 5) | (b[0] >>> 27)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[2] & (b[0] ^ b[1]))) + ((i[6] + 0xc040b340) >>> 0)
         b[3] = (b[3] << 9) | (b[3] >>> 23)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[1] & (b[3] ^ b[0]))) + ((i[11] + 0x265e5a51) >>> 0)
         b[2] = (b[2] << 14) | (b[2] >>> 18)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[0] & (b[2] ^ b[3]))) + ((i[0] + 0xe9b6c7aa) >>> 0)
         b[1] = (b[1] << 20) | (b[1] >>> 12)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[3] & (b[1] ^ b[2]))) + ((i[5] + 0xd62f105d) >>> 0)
         b[0] = (b[0] << 5) | (b[0] >>> 27)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[2] & (b[0] ^ b[1]))) + ((i[10] + 0x02441453) >>> 0)
         b[3] = (b[3] << 9) | (b[3] >>> 23)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[1] & (b[3] ^ b[0]))) + ((i[15] + 0xd8a1e681) >>> 0)
         b[2] = (b[2] << 14) | (b[2] >>> 18)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[0] & (b[2] ^ b[3]))) + ((i[4] + 0xe7d3fbc8) >>> 0)
         b[1] = (b[1] << 20) | (b[1] >>> 12)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[3] & (b[1] ^ b[2]))) + ((i[9] + 0x21e1cde6) >>> 0)
         b[0] = (b[0] << 5) | (b[0] >>> 27)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[2] & (b[0] ^ b[1]))) + ((i[14] + 0xc33707d6) >>> 0)
         b[3] = (b[3] << 9) | (b[3] >>> 23)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[1] & (b[3] ^ b[0]))) + ((i[3] + 0xf4d50d87) >>> 0)
         b[2] = (b[2] << 14) | (b[2] >>> 18)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[0] & (b[2] ^ b[3]))) + ((i[8] + 0x455a14ed) >>> 0)
         b[1] = (b[1] << 20) | (b[1] >>> 12)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[3] & (b[1] ^ b[2]))) + ((i[13] + 0xa9e3e905) >>> 0)
         b[0] = (b[0] << 5) | (b[0] >>> 27)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[2] & (b[0] ^ b[1]))) + ((i[2] + 0xfcefa3f8) >>> 0)
         b[3] = (b[3] << 9) | (b[3] >>> 23)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[1] & (b[3] ^ b[0]))) + ((i[7] + 0x676f02d9) >>> 0)
         b[2] = (b[2] << 14) | (b[2] >>> 18)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[0] & (b[2] ^ b[3]))) + ((i[12] + 0x8d2a4c8a) >>> 0)
         b[1] = (b[1] << 20) | (b[1] >>> 12)
         b[1] += b[2]

         b[0] += (b[1] ^ b[2] ^ b[3]) + ((i[5] + 0xfffa3942) >>> 0)
         b[0] = (b[0] << 4) | (b[0] >>> 28)
         b[0] += b[1]
         b[3] += (b[0] ^ b[1] ^ b[2]) + ((i[8] + 0x8771f681) >>> 0)
         b[3] = (b[3] << 11) | (b[3] >>> 21)
         b[3] += b[0]
         b[2] += (b[3] ^ b[0] ^ b[1]) + ((i[11] + 0x6d9d6122) >>> 0)
         b[2] = (b[2] << 16) | (b[2] >>> 16)
         b[2] += b[3]
         b[1] += (b[2] ^ b[3] ^ b[0]) + ((i[14] + 0xfde5380c) >>> 0)
         b[1] = (b[1] << 23) | (b[1] >>> 9)
         b[1] += b[2]
         b[0] += (b[1] ^ b[2] ^ b[3]) + ((i[1] + 0xa4beea44) >>> 0)
         b[0] = (b[0] << 4) | (b[0] >>> 28)
         b[0] += b[1]
         b[3] += (b[0] ^ b[1] ^ b[2]) + ((i[4] + 0x4bdecfa9) >>> 0)
         b[3] = (b[3] << 11) | (b[3] >>> 21)
         b[3] += b[0]
         b[2] += (b[3] ^ b[0] ^ b[1]) + ((i[7] + 0xf6bb4b60) >>> 0)
         b[2] = (b[2] << 16) | (b[2] >>> 16)
         b[2] += b[3]
         b[1] += (b[2] ^ b[3] ^ b[0]) + ((i[10] + 0xbebfbc70) >>> 0)
         b[1] = (b[1] << 23) | (b[1] >>> 9)
         b[1] += b[2]
         b[0] += (b[1] ^ b[2] ^ b[3]) + ((i[13] + 0x289b7ec6) >>> 0)
         b[0] = (b[0] << 4) | (b[0] >>> 28)
         b[0] += b[1]
         b[3] += (b[0] ^ b[1] ^ b[2]) + ((i[0] + 0xeaa127fa) >>> 0)
         b[3] = (b[3] << 11) | (b[3] >>> 21)
         b[3] += b[0]
         b[2] += (b[3] ^ b[0] ^ b[1]) + ((i[3] + 0xd4ef3085) >>> 0)
         b[2] = (b[2] << 16) | (b[2] >>> 16)
         b[2] += b[3]
         b[1] += (b[2] ^ b[3] ^ b[0]) + ((i[6] + 0x04881d05) >>> 0)
         b[1] = (b[1] << 23) | (b[1] >>> 9)
         b[1] += b[2]
         b[0] += (b[1] ^ b[2] ^ b[3]) + ((i[9] + 0xd9d4d039) >>> 0)
         b[0] = (b[0] << 4) | (b[0] >>> 28)
         b[0] += b[1]
         b[3] += (b[0] ^ b[1] ^ b[2]) + ((i[12] + 0xe6db99e5) >>> 0)
         b[3] = (b[3] << 11) | (b[3] >>> 21)
         b[3] += b[0]
         b[2] += (b[3] ^ b[0] ^ b[1]) + ((i[15] + 0x1fa27cf8) >>> 0)
         b[2] = (b[2] << 16) | (b[2] >>> 16)
         b[2] += b[3]
         b[1] += (b[2] ^ b[3] ^ b[0]) + ((i[2] + 0xc4ac5665) >>> 0)
         b[1] = (b[1] << 23) | (b[1] >>> 9)
         b[1] += b[2]

         b[0] += (b[2] ^ (b[1] | ~b[3])) + ((i[0] + 0xf4292244) >>> 0)
         b[0] = (b[0] << 6) | (b[0] >>> 26)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[0] | ~b[2])) + ((i[7] + 0x432aff97) >>> 0)
         b[3] = (b[3] << 10) | (b[3] >>> 22)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[3] | ~b[1])) + ((i[14] + 0xab9423a7) >>> 0)
         b[2] = (b[2] << 15) | (b[2] >>> 17)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[2] | ~b[0])) + ((i[5] + 0xfc93a039) >>> 0)
         b[1] = (b[1] << 21) | (b[1] >>> 11)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[1] | ~b[3])) + ((i[12] + 0x655b59c3) >>> 0)
         b[0] = (b[0] << 6) | (b[0] >>> 26)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[0] | ~b[2])) + ((i[3] + 0x8f0ccc92) >>> 0)
         b[3] = (b[3] << 10) | (b[3] >>> 22)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[3] | ~b[1])) + ((i[10] + 0xffeff47d) >>> 0)
         b[2] = (b[2] << 15) | (b[2] >>> 17)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[2] | ~b[0])) + ((i[1] + 0x85845dd1) >>> 0)
         b[1] = (b[1] << 21) | (b[1] >>> 11)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[1] | ~b[3])) + ((i[8] + 0x6fa87e4f) >>> 0)
         b[0] = (b[0] << 6) | (b[0] >>> 26)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[0] | ~b[2])) + ((i[15] + 0xfe2ce6e0) >>> 0)
         b[3] = (b[3] << 10) | (b[3] >>> 22)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[3] | ~b[1])) + ((i[6] + 0xa3014314) >>> 0)
         b[2] = (b[2] << 15) | (b[2] >>> 17)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[2] | ~b[0])) + ((i[13] + 0x4e0811a1) >>> 0)
         b[1] = (b[1] << 21) | (b[1] >>> 11)
         b[1] += b[2]
         b[0] += (b[2] ^ (b[1] | ~b[3])) + ((i[4] + 0xf7537e82) >>> 0)
         b[0] = (b[0] << 6) | (b[0] >>> 26)
         b[0] += b[1]
         b[3] += (b[1] ^ (b[0] | ~b[2])) + ((i[11] + 0xbd3af235) >>> 0)
         b[3] = (b[3] << 10) | (b[3] >>> 22)
         b[3] += b[0]
         b[2] += (b[0] ^ (b[3] | ~b[1])) + ((i[2] + 0x2ad7d2bb) >>> 0)
         b[2] = (b[2] << 15) | (b[2] >>> 17)
         b[2] += b[3]
         b[1] += (b[3] ^ (b[2] | ~b[0])) + ((i[9] + 0xeb86d391) >>> 0)
         b[1] = (b[1] << 21) | (b[1] >>> 11)
         b[1] += b[2]
      ...
      encode: function (string) {
         ...
         while (inputlength--) {
            ...
            if (code >= 0xdc00 && code <= 0xdfff) {
               throw new Error('Invalid sequence in conversion input')
            } else if (code >= 0xd800 && code <= 0xdbff) {
               if (inputlength < 1) {
                  ...
                  if (codehi < 0xdc00 || codehi > 0xdfff) {
                     ...
                     character = (codehi - 0xd800) * 0x400 + code - 0xdc00 + 0x10000
                  }
                  inputlength--
               }
            } else {
...
Sol.prototype.toSolString = Sol.prototype.toString = function () {
   ...
   if (this.absolute) {
      var num = this.floating.toFixed(6),
         m = num.match(/e(\+|-)/)
      if (m) return m[1] === '+' ? '∞ſ' : '-∞ſ'

      var sep = num.split('.')
      var sol =
         sep[0].replace(/(\d)(?=(\d{3})+$)/g, '$1 ') +
         ' ſ ' +
         sep[1].substr(0, 3) +
         ' ' +
         sep[1].substr(3, 3)
...
Sol.prototype.toHumanString = function () {
   ...
   for (var i = 0, len = keys.length; i < len; i++) {
      ...
      if (numspecific) {
         builder.push(numspecific + ' ' + keys[i][0] + (numspecific === 1 ? '' : 's'))
      }
   }
...
Sol.parseHuman = function (text) {
   ...
   m = text.match(/([0-9.]+)\s*y/)
   if (m) {
      t += m[1] * 31536000000
   }
   m = text.match(/([0-9.]+)\s*mo/)
   if (m) {
      t += m[1] * 2678400000
   }
   m = text.match(/([0-9.]+)\s*w/)
   if (m) {
      t += m[1] * 604800000
   }
   m = text.match(/([0-9.]+)\s*d/)
   if (m) {
      t += m[1] * 86400000
   }
   m = text.match(/([0-9.]+)\s*h/)
   if (m) {
      t += m[1] * 3600000
   }
   m = text.match(/([0-9.]+)\s*m(?:$|[^os])/)
   if (m) {
      t += m[1] * 60000
   }
   m = text.match(/([0-9.]+)\s*s/)
   if (m) {
      t += m[1] * 1000
   }
   m = text.match(/([0-9.]+)\s*ms/)
   if (m) {
      t += m[1] * 1
   }
