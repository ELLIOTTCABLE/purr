        ...
        var tinysong = function(context, song_name, number, cb){
            ...
            request({ uri: uri, json: true, encoding: 'utf8'
                ...
                if (err || songs.error) {
                    ...
                    blue = "\0o032", green = "\0o033", yellow = "\0o037", reset="\0o17"
